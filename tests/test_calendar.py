"""Tests for the FedEx deliveries calendar."""

from datetime import datetime, timezone
from unittest.mock import MagicMock

from custom_components.fedex.calendar import FedExDeliveriesCalendar
...
def _cal(data):
    return FedExDeliveriesCalendar(_coordinator(data), _entry())
    ...
    cal = _cal(
        [
            _parcel(
                ...
                planned_from="2099-01-01T10:00:00Z",
                pickup=True,
                pickup_point="FedEx Shop",
            )
        ]
    )
    assert cal._events()[0].location == "FedEx Shop"
