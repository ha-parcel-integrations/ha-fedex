"""pytest configuration for the FedEx test suite."""
...
def auto_enable_custom_integrations(enable_custom_integrations):
    """Make ``custom_components.fedex`` loadable from config-flow / setup tests."""
    yield
...
def reset_one_shot_warnings():
    ...
    """
    from custom_components.fedex import parcels
